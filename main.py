...
#===================Python Variables=======================
menu_category = ["Tea & Coffee","North Indian","Fast Food","South Indian","Starters","Dessert"]

menu_category_dict = {"Tea & Coffee":"1 Tea & Coffee.txt","North Indian":"2 North Indian.txt",
                "Fast Food":"3 Fast Food.txt","South Indian":"4 South Indian.txt",
                "Starters":"5 Starters.txt","Dessert":"6 Dessert.txt"}
...
root.title("Welcome to Spotlight Hotel")
...
title_frame = Frame(root, bd=8, bg="#8f008f", relief=GROOVE)
title_frame.pack(side=TOP, fill="x")

title_label = Label(title_frame, text="Spotlight Hotel", 
                    font=("times new roman", 20, "bold"),bg = "#8f008f", fg="#ffffff", pady=5)
title_label.pack()

#==============Customer=============
customer_frame = LabelFrame(root,text="Customer Info",font=("times new roman", 15, "bold"),
                            bd=8, bg="#db00db",fg="#443266", relief=GROOVE)
customer_frame.pack(side=TOP, fill="x")

customer_name_label = Label(customer_frame, text="Name", 
                    font=("arial", 15, "bold"),bg = "#db00db", fg="#ffffff")
...
#===============Menu===============
menu_frame = Frame(root,bd=8, bg="#8f008f", relief=GROOVE)
menu_frame.place(x=0,y=125,height=685,width=680)

menu_label = Label(menu_frame, text="Menu", 
                    font=("times new roman", 20, "bold"),bg = "#8f008f", fg="#C3C3E5", pady=0)
menu_label.pack(side=TOP,fill="x")

menu_category_frame = Frame(menu_frame,bg="#8f008f",pady=10)
menu_category_frame.pack(fill="x")

combo_lable = Label(menu_category_frame,text="Select Type", 
                    font=("arial", 12, "bold"),bg = "#8f008f", fg="#ffffff")
...
#===============Item Frame=============
item_frame = Frame(root,bd=8, bg="#8f008f", relief=GROOVE)
item_frame.place(x=680,y=125,height=210,width=880)

item_title_label = Label(item_frame, text="Item", 
                    font=("times new roman", 20, "bold"),bg = "#8f008f", fg="#C3C3E5")
item_title_label.pack(side=TOP,fill="x")

item_frame2 = Frame(item_frame, bg="#8f008f")
...
item_frame3 = Frame(item_frame, bg="#8f008f")
...
#==============Order Frame=====================
order_frame = Frame(root,bd=8, bg="#db00db", relief=GROOVE)
order_frame.place(x=680,y=335,height=400,width=880)

order_title_label = Label(order_frame, text="Your Order", 
                    font=("times new roman", 20, "bold"),bg = "#db00db", fg="#443266")
...
total_price_label = Label(order_frame, text="Total Price", 
                    font=("arial", 12, "bold"),bg = "#db00db", fg="#443266")
